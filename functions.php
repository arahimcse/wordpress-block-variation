 ...
 */
function twentytwenyfive_extend_block_practice() {
				$args = array(
					'handle' => "twentytwentyfive-columns",
					'src'    => get_stylesheet_directory_uri('assets/css/columns.css'),
					'var'	=> wp_get_theme(get_template())->get('Version'),
					'path'	=> get_stylesheet_directory_uri('assets/css/columns.css')
				);
				wp_enqueue_block_style( "core/columns", $args );
		}
add_action( 'init', 'twentytwenyfive_extend_block_practice' );
/**
